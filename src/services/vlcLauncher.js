...
psFile.WriteLine "        $uriSub = ([System.Uri]$subPath).AbsoluteUri"
psFile.WriteLine "        $arg2 = '""--sub-file=' + $uriSub + '""'"
psFile.WriteLine "        $argList += ""--sub-track=0"""
